    ...
    <div class="tw-w-full tw-px-96 tw-bg-[#7e7e7e] tw-text-white tw-pt-20">
      ...
      <div class="tw-flex tw-gap-10 tw-h-full">
        ...
        <div class="tw-w-[33rem]">
          ...
          <p class="tw-text-[18px] tw-font-medium tw-tracking-wide tw-leading-[1.5em] tw-mt-5">
...
<script setup>
import carousel1 from "../../../assets/traditionalCrafts/LaiFa/2_1.jpg";
import carousel2 from "../../../assets/traditionalCrafts/LaiFa/2_2.jpg";
import carousel3 from "../../../assets/traditionalCrafts/LaiFa/2_3.jpg";
</script>
<style scoped></style>