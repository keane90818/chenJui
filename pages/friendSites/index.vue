<template>
  <div class=" tw-items-center tw-justify-center tw-p-0">
    <div class="tw-flex tw-py-20 tw-w-full max-lg:tw-px-12 lg:tw-px-96 tw-bg-[#E5D2C2] tw-gap-20 max-lg:tw-flex-col">
      <div class="lg:tw-w-[36rem]">
        <p class="tw-font-extrabold tw-text-5xl tw-text-[#C07C56] text-shadow">友站連結</p>
        <hr class="tw-border-[#C07C56] tw-mt-3 tw-mb-10">
        <div class="tw-pt-5 tw-font-bold max-lg:tw-text-[20px] lg:tw-text-[18px] tw-text-[#8D340F]">歷史建築
          <p> -南投戲院</p>
          <p> -登瀛書院</p>
        </div>
        <div class="tw-pt-5 tw-font-bold max-lg:tw-text-[20px] lg:tw-text-[18px] tw-text-[#918D3B]">傳統技藝
          <p> -來發鐵店</p>
          <p> -冠德竹木精品社</p>
        </div>
        <div class="tw-pt-5 tw-font-bold max-lg:tw-text-[20px] lg:tw-text-[18px] tw-text-[#710400]">美食老店
          <p> -黑狗兄傳統餅舖</p>
          <p> -源振發製麵廠</p>
        </div>
      </div>
        <div class="lg:tw-h-[400px] lg:tw-w-[600px] ">
...
<script setup>
import carousel1 from "../../assets/friendSites/1_1.jpg";
import carousel2 from "../../assets/friendSites/1_2.jpg";
import carousel3 from "../../assets/friendSites/1_3.jpg";
import carousel4 from "../../assets/friendSites/1_4.jpg";
