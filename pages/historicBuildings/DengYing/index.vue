    ...
    <div class="tw-w-full lg:tw-px-96 max-lg:tw-px-12 tw-pt-10 tw-pb-20">
      ...
      <div class="tw-flex tw-gap-20 max-lg:tw-flex-col">
        <div class="lg:tw-w-[40rem]">
          ...
          <p class="tw-text-[16px] tw-font-medium tw-tracking-wide tw-text-gray-500 tw-leading-[1.5em]">
            登瀛書院為草屯首學，至今已有175年的歷史，在清朝時期道光27年，當時因爲教育不普及，民間社會崇尚透過讀書增識益智，因此地方仕紳為了讓大家有一個能夠學習的機會，並發起民間書社來倡議募資設立學堂，登瀛書院就此成立。
          </p>
          <p class="tw-text-[16px] tw-font-medium tw-tracking-wide tw-text-gray-500 tw-leading-[1.5em] tw-pt-5">
    ...
    <div class="tw-w-full lg:tw-px-72 max-lg:tw-px-12 tw-bg-[#B2B2B2] tw-text-white tw-py-20">
      <div class="tw-flex tw-gap-20 tw-h-full max-lg:tw-flex-col">
        ...
        <div class="lg:tw-w-[35rem] max-lg:tw-order-1">
          ...
          <p class="tw-text-[18px] tw-font-medium tw-tracking-wide tw-leading-[2em] tw-pt-5">
...
<script setup>
import carousel1 from "../../../assets/historicBuildings/DengYing/3_1.jpg";
import carousel2 from "../../../assets/historicBuildings/DengYing/3_2.jpg";
import carousel3 from "../../../assets/historicBuildings/DengYing/3_3.jpg";
import carousel4 from "../../../assets/historicBuildings/DengYing/3_4.jpg";
import carousel5 from "../../../assets/historicBuildings/DengYing/3_5.jpg";
import carousel6 from "../../../assets/historicBuildings/DengYing/3_6.jpg";
import carousel7 from "../../../assets/historicBuildings/DengYing/3_7.jpg";
import carousel8 from "../../../assets/historicBuildings/DengYing/3_8.jpg";
</script>
<style scoped></style>